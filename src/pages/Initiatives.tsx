...
const initiatives = [
  {
    id: "01",
    name: "Planetary Green",
    sector: "Environmental · Humanitarian",
    status: "Active",
    location: "London · Global",
    charity: "No. 1119453",
    headline: "A systemic framework for climate accountability, biodiversity protection, and humanitarian healthcare.",
    body: `Planetary Green (formerly the Millennium Health Microscope Foundation) is a UK registered charity operating under sole trusteeship, originally established with sponsorship from the Bill and Melinda Gates Foundation under Grand Challenges Grant OPP1015837.

The initiative operates across three interconnected domains: environmental surveillance and protection, clean energy systems, and humanitarian healthcare. Rather than participating in the existing carbon credit market — which Hamilton has described as insufficiently rigorous — Planetary Green advocates for satellite-verified carbon accountability: specific rainforest areas are registered and monitored from space, with exact compensation tied to verified protection costs.

Associated programmes include the deployment of COVID-19 vaccination programmes across Malaysia, Myanmar, and the Philippines (one million doses), delivery of FFP2 masks to African regions via Boeing 747-400F aircraft, and supply of masks to the German Federal Government for front-line healthcare workers.`,
    metrics: [
      { value: "1M+", label: "Vaccines Deployed" },
      { value: "3", label: "747-400F Missions" },
      { value: "1M+", label: "Masks Supplied" },
    ],
  },
  {
    id: "02",
    ...
    status: "Development",
    location: "Global",
    headline: "Nano-capsule coating technology eliminating disease-carrying mosquitoes with over 90% effectiveness.",
    body: `Vectorcide is a proprietary nano-capsule coating technology designed to eradicate disease-carrying mosquito populations in targeted geographical zones. The technology achieves effectiveness rates exceeding 90% — representing a step-change from existing vector control approaches which rely on broad-spectrum pesticides with diminishing effectiveness and significant ecological side effects.

The implications are profound. Diseases transmitted by mosquitoes — including malaria, dengue fever, Zika virus, and yellow fever — account for hundreds of thousands of deaths annually, disproportionately affecting populations in tropical and subtropical regions. A targeted, high-efficacy solution with a limited ecological footprint could represent one of the most significant public health interventions of the coming decade.

Vectorcide operates within the broader Planetary Green humanitarian framework, with deployment strategies designed in collaboration with regional health authorities.`,
    metrics: [
  ...
  },
  {
    ...
    status: "Development",
    location: "London · Global",
    headline: "Blockchain-based biodiversity asset platform protecting rainforests at institutional scale.",
...
The design of Planetary X reflects Hamilton's long-standing concern with the integrity of environmental accountability systems: that compensation for carbon emission must be provably linked to a real, measurable, and permanent act of protection — not an abstract offset against an unrelated activity. Satellite surveillance provides the verification layer that the existing market lacks.`,
    metrics: [
  ...
  },
  {
    ...
    headline: "Advanced aerial geophysical survey system detecting underground resources with precision mapping.",
...
Humanitarian applications include the identification of underground water sources in arid regions and the strategic positioning of new urban development (such as NEOM in Saudi Arabia) in areas that are geologically and hydrologically compatible with long-term habitation.`,
    metrics: [
  ...
  },
  {
    ...
    status: "Active",
    location: "Global",
    headline: "Converting plastic and tyre waste into light crude oil and electricity.",
    body: `The waste-to-energy systems developed under the Hamilton Strategy Group portfolio convert plastic waste and end-of-life tyres into light crude oil and electrical energy through pyrolysis-based processes. The technology addresses two interconnected crises simultaneously: the global accumulation of plastic waste in landfill and ocean environments, and the demand for clean, locally-produced energy in regions without access to grid infrastructure.

The commercial model is designed for deployment in regions with high informal waste accumulation and energy poverty — particularly across sub-Saharan Africa and Southeast Asia — creating economic value from materials that currently generate only environmental liability. The technology integrates naturally with the broader Planetary Green environmental framework and with the humanitarian infrastructure developed through the Rubrique Hamilton Management World Health Initiative.`,
    metrics: [
  ...
  {
    id: "06",
    name: "African Resource Development",
    sector: "Infrastructure · Resource Economics",
    status: "Active",
    location: "Sub-Saharan Africa",
    headline: "Mineral discovery, sustainable energy, and economic development programmes across Africa.",
    body: `The African Resource and Infrastructure Development programme applies TechnoImaging geophysical survey capabilities to the identification and strategic mapping of mineral, water, and energy resources across sub-Saharan Africa. The continent contains the world's largest reserves of many critical minerals — including cobalt, lithium, platinum group metals, and rare earth elements — but their discovery and monetisation has historically been constrained by the absence of precise, low-cost survey technology.

TechnoImaging changes this equation. Governments can now identify and value their subsurface wealth without the capital expenditure of exploratory drilling, enabling more informed negotiation with extraction partners and greater retention of economic value within sovereign territories. The programme is designed with explicit humanitarian objectives: the creation of employment, the development of healthcare and accommodation infrastructure in remote areas, and the establishment of sustainable energy systems alongside resource extraction.`,
    metrics: [
            ...
            <div className="dossier-card border border-border group hover:border-gold/20 transition-all duration-700">
              <div className="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div className="lg:col-span-2 p-8">
                  <p className="font-mono text-[10px] text-gold/50 uppercase tracking-widest mb-4">
                    {item.headline}
                  </p>
                  {item.body.split("\n\n").map((para, j) => (
